...
# resource "yandex_lb_target_group" "back_alb_tg" {
#   name      = "web-alb-target-group"
#   folder_id = var.folder_id
...
# resource "yandex_alb_backend_group" "back_alb_bg" {
#   name = "back"
#   http_backend {
#     name             = "back"
#     weight           = 1
#     port             = 80
#     target_group_ids = ["${yandex_lb_target_group.back_alb_tg.id}"]
...
#       }
#       http_route_action {
#         backend_group_id = yandex_alb_backend_group.back_alb_bg.id
#         timeout          = "3s"
#       }
#       redirect_action {
#         replace_prefix = "/"
